...
import { type BusinessProfile, type InvoiceWithExtras, Plan } from "../backend";
...
export default function InvoicePreviewPage() {
  ...
  // Scale state for mobile responsiveness
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-6 space-y-6">
      ...
      {/* Invoice Preview — scales down on mobile to fit screen width */}
      <div
      ...
      >
        {TemplateComponent ? (
          ...
          >
            {/* printRef wraps the unscaled template so PDF is always full quality */}
            <div
              ref={printRef}
              style={{
                position: "absolute",
          ...
          <div className="flex items-center justify-center h-96 bg-white text-muted-foreground">
