...
export default function InvoiceFormPage() {
  ...
  useEffect(() => {
    if (existingInvoice && isEdit) {
      ...
      const bdVal = Array.isArray(bd) ? bd[0] : (bd as any);
      const tcVal = Array.isArray(tc) ? tc[0] : (tc as any);
            ...
            <div className="space-y-5">
              <div className="space-y-1.5">
                ...
                <p className="text-xs text-muted-foreground">
                  Enter your bank details for payment. This will appear on the
                  invoice.
                </p>
              </div>
              <div className="space-y-1.5">
                ...
                />
                <p className="text-xs text-muted-foreground">
                  These terms will be printed at the bottom of your invoice.
                </p>
              </div>
              <button
                type="button"
