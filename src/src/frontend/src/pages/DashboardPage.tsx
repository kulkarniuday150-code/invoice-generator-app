  ...
  return (
    <div className="space-y-6">
      ...
      {remainingCredits > 0 && !showFreeBanner && (
        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {isLoading ? (
          ...
          stats.map(
            ({ title, value, icon: Icon, iconBg, iconColor, gradient }) => (
              <Card key={title} className="shadow-card overflow-hidden">
                <CardContent className="p-4">
                  <div
                  ...
                  <div className="relative flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-foreground mt-1 font-heading">
                        {value}
                      </p>
                    </div>
                    <div
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        ...
        >
          <Link to="/clients" className="flex flex-col items-center gap-2">
            ...
            <span className="text-sm font-semibold">View Clients</span>
          </Link>
        </Button>
      </div>
