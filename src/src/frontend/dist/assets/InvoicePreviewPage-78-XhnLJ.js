const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/server.browser-DRqnTRMT.js","assets/index-CQurMIuK.js","assets/index-DuwHkBc3.css"])))=>i.map(i=>d[i]);
import { d as createLucideIcon, j as jsxRuntimeExports, n as Crown, a2 as useParams, V as useNavigate, a3 as useInvoice, u as useBusinessProfile, a5 as useUpdateInvoice, r as reactExports, b as Plan, B as Button, a8 as ArrowLeft, L as LoaderCircle, c as ue, F as FileText, ae as __vitePreload, R as React } from "./index-CQurMIuK.js";
  ...
  const handlePrint = async () => {
    ...
    try {
      ...
      const { renderToStaticMarkup } = await __vitePreload(async () => {
        const { renderToStaticMarkup: renderToStaticMarkup2 } = await import("./server.browser-DRqnTRMT.js").then((n) => n.s);
