import { r as reactExports, ac as reactDomExports } from "./index-CQurMIuK.js";
 ...
 */
var React$1 = reactExports, ReactDOM$1 = reactDomExports;
...
var REACT_ELEMENT_TYPE$1 = Symbol.for("react.transitional.element"), REACT_PORTAL_TYPE$1 = Symbol.for("react.portal"), REACT_FRAGMENT_TYPE$1 = Symbol.for("react.fragment"), REACT_STRICT_MODE_TYPE$1 = Symbol.for("react.strict_mode"), REACT_PROFILER_TYPE$1 = Symbol.for("react.profiler"), REACT_PROVIDER_TYPE$1 = Symbol.for("react.provider"), REACT_CONSUMER_TYPE$1 = Symbol.for("react.consumer"), REACT_CONTEXT_TYPE$1 = Symbol.for("react.context"), REACT_FORWARD_REF_TYPE$1 = Symbol.for("react.forward_ref"), REACT_SUSPENSE_TYPE$1 = Symbol.for("react.suspense"), REACT_SUSPENSE_LIST_TYPE$1 = Symbol.for("react.suspense_list"), REACT_MEMO_TYPE$1 = Symbol.for("react.memo"), REACT_LAZY_TYPE$1 = Symbol.for("react.lazy"), REACT_SCOPE_TYPE$1 = Symbol.for("react.scope"), REACT_ACTIVITY_TYPE$1 = Symbol.for("react.activity"), REACT_LEGACY_HIDDEN_TYPE$1 = Symbol.for("react.legacy_hidden"), REACT_MEMO_CACHE_SENTINEL$1 = Symbol.for("react.memo_cache_sentinel"), REACT_VIEW_TRANSITION_TYPE$1 = Symbol.for("react.view_transition"), MAYBE_ITERATOR_SYMBOL$1 = Symbol.iterator, isArrayImpl$1 = Array.isArray;
...
var PRELOAD_NO_CREDS$1 = [], scriptRegex$1 = /(<\/|<)(s)(cript)/gi;
function scriptReplacer$1(match, prefix2, s2, suffix2) {
...
function getChildFormatContext$1(parentContext, type, props) {
  switch (type) {
    ...
    case "colgroup":
      return createFormatContext$1(9, null, parentContext.tagScope);
    case "tr":
    ...
    case "html":
      if (0 === parentContext.insertionMode)
        return createFormatContext$1(1, null, parentContext.tagScope);
  }
  return 6 <= parentContext.insertionMode || 2 > parentContext.insertionMode ? createFormatContext$1(2, null, parentContext.tagScope) : parentContext;
}
    ...
    if (hasOwnProperty$1.call(style, styleName)) {
      ...
      if (null != styleValue && "boolean" !== typeof styleValue && "" !== styleValue) {
        if (0 === styleName.indexOf("--")) {
          ...
          nameChunk = styleNameCache$1.get(styleName), void 0 === nameChunk && (nameChunk = escapeTextForBrowser$1(
            styleName.replace(uppercasePattern$1, "-$1").toLowerCase().replace(msPattern$1, "-ms-")
          ), styleNameCache$1.set(styleName, nameChunk)), styleValue = "number" === typeof styleValue ? 0 === styleValue || unitlessNumbers$1.has(styleName) ? "" + styleValue : styleValue + "px" : escapeTextForBrowser$1(("" + styleValue).trim());
...
function pushAttribute$1(target, name, value) {
  switch (name) {
    ...
    case "capture":
    case "download":
      true === value ? target.push(" ", name, '=""') : false !== value && "function" !== typeof value && "symbol" !== typeof value && target.push(" ", name, '="', escapeTextForBrowser$1(value), '"');
      break;
    case "cols":
    case "rows":
    case "size":
...
function styleReplacer$1(match, prefix2, s2, suffix2) {
...
function pushStartInstance$1(target$jscomp$0, type, props, resumableState, renderState, preambleState, hoistableState, formatContext, textEmbedded, isFallback) {
  switch (type) {
    case "div":
    case "span":
    case "svg":
    ...
    case "form":
      ...
      target$jscomp$0.push(">");
      null !== formActionName && (target$jscomp$0.push('<input type="hidden"'), pushStringAttribute$1(target$jscomp$0, "name", formActionName), target$jscomp$0.push("/>"), null != formData$jscomp$1 && formData$jscomp$1.forEach(pushAdditionalFormField$1, target$jscomp$0));
    ...
    case "link":
      ...
      if (4 === formatContext.insertionMode || formatContext.tagScope & 1 || null != props.itemProp || "string" !== typeof rel || "string" !== typeof href || "" === href) {
        ...
        props.onLoad || props.onError ? JSCompiler_inline_result$jscomp$4 = pushLinkImpl$1(
          target$jscomp$0,
          props
        ) : (textEmbedded && target$jscomp$0.push("<!-- -->"), JSCompiler_inline_result$jscomp$4 = isFallback ? null : pushLinkImpl$1(renderState.hoistableChunks, props));
      ...
      if (4 === formatContext.insertionMode || formatContext.tagScope & 1 || null != props.itemProp || "string" !== typeof precedence$jscomp$0 || "string" !== typeof href$jscomp$0 || "" === href$jscomp$0) {
        ...
        if (null !== (resumableState.styleResources.hasOwnProperty(href$jscomp$0) ? resumableState.styleResources[href$jscomp$0] : void 0)) {
          ...
          styleQueue$jscomp$0 ? styleQueue$jscomp$0.hrefs.push(
            escapeTextForBrowser$1(href$jscomp$0)
          ) : (styleQueue$jscomp$0 = {
            precedence: escapeTextForBrowser$1(precedence$jscomp$0),
            rules: [],
            hrefs: [escapeTextForBrowser$1(href$jscomp$0)],
            sheets: /* @__PURE__ */ new Map()
    ...
    case "meta":
      if (4 === formatContext.insertionMode || formatContext.tagScope & 1 || null != props.itemProp)
        ...
        textEmbedded && target$jscomp$0.push("<!-- -->"), JSCompiler_inline_result$jscomp$7 = isFallback ? null : "string" === typeof props.charSet ? pushSelfClosing$1(renderState.charsetChunks, props, "meta") : "viewport" === props.name ? pushSelfClosing$1(renderState.viewportChunks, props, "meta") : pushSelfClosing$1(renderState.hoistableChunks, props, "meta");
...
function writePreambleContribution$1(destination, preambleState) {
...
var currentlyRenderingBoundaryHasStylesToHoist$1 = false, destinationHasCapacity$1 = true;
...
function hasStylesToHoist$1(stylesheet) {
  return 2 !== stylesheet.state ? currentlyRenderingBoundaryHasStylesToHoist$1 = true : false;
}
...
function preloadLateStyle$1(stylesheet) {
  if (0 === stylesheet.state) {
    ...
    for (stylesheet = 0; stylesheet < stylesheetFlushingQueue$1.length; stylesheet++)
...
function writeStyleResourceDependenciesInJS$1(destination, hoistableState) {
  ...
  hoistableState.stylesheets.forEach(function(resource) {
    if (2 !== resource.state)
      if (3 === resource.state)
        destination.push(nextArrayOpenBrackChunk), resource = escapeJSObjectForInstructionScripts$1(
          "" + resource.props.href
  ...
  if (void 0 !== bootstrapModules)
    for (bootstrapScripts = 0; bootstrapScripts < bootstrapModules.length; bootstrapScripts++)
      props = bootstrapModules[bootstrapScripts], crossOrigin = src = void 0, integrity = {
        ...
        '" integrity="',
        escapeTextForBrowser$1(crossOrigin)
      ), "string" === typeof src && bootstrapChunks.push('" crossorigin="', escapeTextForBrowser$1(src)), bootstrapChunks.push('" async=""><\/script>');
  return {
...
function pushTextInstance$1(target, text, renderState, textEmbedded) {
  ...
  "" === text ? target = textEmbedded : (textEmbedded && target.push("<!-- -->"), target.push(escapeTextForBrowser$1(text)), target = true);
  return target;
}
...
function describeComponentStackByType$1(type) {
  ...
  if ("function" === typeof type)
    return type.prototype && type.prototype.isReactComponent ? describeNativeComponentFrame$1(type, true) : describeNativeComponentFrame$1(type, false);
...
function createSuspenseBoundary$1(request, fallbackAbortableTasks, contentPreamble, fallbackPreamble) {
  return {
    status: 0,
    rootSegmentID: -1,
    parentFlushed: false,
...
function createRenderTask$1(request, thenableState2, node, childIndex, blockedBoundary, blockedSegment, blockedPreamble, hoistableState, abortSet, keyPath, formatContext, context, treeContext, componentStack, isFallback) {
...
function renderWithHooks$1(request, task, keyPath, Component, props, secondArg) {
  ...
  for (request = Component(props, secondArg); didScheduleRenderPhaseUpdate$1; )
    didScheduleRenderPhaseUpdate$1 = false, actionStateCounter$1 = localIdCounter$1 = 0, actionStateMatchingIndex$1 = -1, thenableIndexCounter$1 = 0, numberOfReRenders$1 += 1, workInProgressHook$1 = null, request = Component(props, secondArg);
  resetHooksState$1();
  return request;
}
...
function renderElement$1(request, task, keyPath, type, props, ref) {
  if ("function" === typeof type)
    ...
    if (newProps = task.blockedSegment, null === newProps)
      ...
      task.keyPath = keyPath;
      3 === (task.formatContext = getChildFormatContext$1(defaultProps, type, props)).insertionMode ? (keyPath = createPendingSegment$1(
        request,
        0,
        null,
        task.formatContext,
        false,
        false
      ), newProps.preambleChildren.push(keyPath), keyPath = createRenderTask$1(
        request,
        null,
        ref,
        -1,
        ...
        task.componentStack,
        task.isFallback
      ), pushComponentStack$1(keyPath), request.pingedTasks.push(keyPath)) : renderNode$1(request, task, ref, -1);
    ...
    switch (type) {
      ...
      case REACT_SUSPENSE_TYPE$1:
        a: if (null !== task.replay) {
          ...
          var newBoundary = 2 > task.formatContext.insertionMode ? createSuspenseBoundary$1(
            request,
            fallbackAbortSet,
            createPreambleState$1(),
            createPreambleState$1()
          ) : createSuspenseBoundary$1(request, fallbackAbortSet, null, null);
          ...
          if (null !== request.trackedPostpones) {
            ...
            try {
              renderNode$1(request, task, propName, -1), pushSegmentFinale(
            ...
            try {
              if (renderNode$1(request, task, props, -1), pushSegmentFinale(
                contentRootSegment.chunks,
                request.renderState,
                contentRootSegment.lastPushedText,
                contentRootSegment.textEmbedded
              ), contentRootSegment.status = 1, queueCompletedSegment$1(newBoundary, contentRootSegment), 0 === newBoundary.pendingTasks && 0 === newBoundary.status) {
                newBoundary.status = 1;
                0 === request.pendingRootTasks && task.blockedPreamble && preparePreamble$1(request);
                break a;
              }
            } catch (thrownValue$28) {
              newBoundary.status = 4, 12 === request.status ? (contentRootSegment.status = 3, newProps = request.fatalError) : (contentRootSegment.status = 4, newProps = thrownValue$28), defaultProps = getThrownInfo$1(task.componentStack), initialState = logRecoverableError$1(
                request,
                newProps,
                defaultProps
              ), newBoundary.errorDigest = initialState, untrackBoundary$1(request, newBoundary);
            } finally {
                ...
                if (keyOrIndex === node$jscomp$0[1]) {
                  if (4 === node$jscomp$0.length) {
                    ...
                    b: {
                      ...
                      props = 2 > task.formatContext.insertionMode ? createSuspenseBoundary$1(
                        request,
                        fallbackAbortSet,
                        createPreambleState$1(),
                        createPreambleState$1()
                      ) : createSuspenseBoundary$1(
                        request,
                        fallbackAbortSet,
                        null,
                        null
                      ...
                      try {
                        ...
                        props.status = 4, childNodes = getThrownInfo$1(task.componentStack), replay = logRecoverableError$1(
                          request,
                          error,
                          childNodes
...
function abortRemainingReplayNodes$1(request$jscomp$0, boundary, nodes, slots, error, errorDigest$jscomp$0) {
  for (var i = 0; i < nodes.length; i++) {
    ...
    if (4 === node.length)
      ...
      node = node[5];
      var request = request$jscomp$0, errorDigest = errorDigest$jscomp$0, resumedBoundary = createSuspenseBoundary$1(
        request,
        /* @__PURE__ */ new Set(),
        null,
        null
...
function finishedTask$1(request, boundary, segment) {
  if (null === boundary) {
    ...
    boundary.pendingTasks--, 4 !== boundary.status && (0 === boundary.pendingTasks ? (0 === boundary.status && (boundary.status = 1), null !== segment && segment.parentFlushed && 1 === segment.status && queueCompletedSegment$1(boundary, segment), boundary.parentFlushed && request.completedBoundaries.push(boundary), 1 === boundary.status && (boundary.fallbackAbortableTasks.forEach(abortTaskSoft$1, request), boundary.fallbackAbortableTasks.clear(), 0 === request.pendingRootTasks && null === request.trackedPostpones && null !== boundary.contentPreamble && preparePreamble$1(request))) : null !== segment && segment.parentFlushed && 1 === segment.status && (queueCompletedSegment$1(boundary, segment), 1 === boundary.completedSegments.length && boundary.parentFlushed && request.partialBoundaries.push(boundary)));
  request.allPendingTasks--;
  0 === request.allPendingTasks && completeAll$1(request);
}
    ...
    try {
      ...
      for (i = 0; i < pingedTasks.length; i++) {
        ...
        if (null === segment) {
          ...
          try {
            retryNode$1(request, task), pushSegmentFinale(
              request$jscomp$1.chunks,
              request.renderState,
              request$jscomp$1.lastPushedText,
              request$jscomp$1.textEmbedded
            ), task.abortSet.delete(task), request$jscomp$1.status = 1, finishedTask$1(request, task.blockedBoundary, request$jscomp$1);
          } catch (thrownValue) {
            resetHooksState$1();
            ...
            if ("object" === typeof x$jscomp$0 && null !== x$jscomp$0 && "function" === typeof x$jscomp$0.then) {
              ...
              null === boundary$jscomp$0 ? fatalError$1(request, x$jscomp$0) : (boundary$jscomp$0.pendingTasks--, 4 !== boundary$jscomp$0.status && (boundary$jscomp$0.status = 4, boundary$jscomp$0.errorDigest = request$jscomp$0, untrackBoundary$1(request, boundary$jscomp$0), boundary$jscomp$0.parentFlushed && request.clientRenderedBoundaries.push(boundary$jscomp$0), 0 === request.pendingRootTasks && null === request.trackedPostpones && null !== boundary$jscomp$0.contentPreamble && preparePreamble$1(request)));
              request.allPendingTasks--;
              0 === request.allPendingTasks && completeAll$1(request);
            }
          } finally {
...
function preparePreambleFromSubtree$1(request, segment, collectedPreambleSegments) {
  ...
  for (var pendingPreambles = false, i = 0; i < segment.children.length; i++)
    pendingPreambles = preparePreambleFromSegment$1(
      request,
      segment.children[i],
...
function preparePreambleFromSegment$1(request, segment, collectedPreambleSegments) {
  ...
  switch (boundary.status) {
    ...
    case 4:
      if (1 === segment.status)
        return hoistPreambleState$1(request.renderState, fallbackPreamble), preparePreambleFromSubtree$1(
          request,
          segment,
          collectedPreambleSegments
        );
...
function preparePreamble$1(request) {
  if (request.completedRootSegment && null === request.completedPreambleSegments) {
    var collectedPreambleSegments = [], hasPendingPreambles = preparePreambleFromSegment$1(
      request,
...
function flushSegment$1(request, destination, segment, hoistableState) {
  ...
  if (4 === boundary.status) {
    if (!request.renderState.generateStaticMarkup) {
      ...
      errorDigest && (destination.push(' data-dgst="'), errorDigest = escapeTextForBrowser$1(errorDigest), destination.push(errorDigest), destination.push('"'));
      destination.push("></template>");
    }
    flushSubtree$1(request, destination, segment, hoistableState);
    request.renderState.generateStaticMarkup ? destination = true : ((request = boundary.fallbackPreamble) && writePreambleContribution$1(destination, request), destination = destination.push("<!--/$-->"));
    return destination;
  }
  if (1 !== boundary.status)
    return 0 === boundary.status && (boundary.rootSegmentID = request.nextSegmentId++), 0 < boundary.completedSegments.length && request.partialBoundaries.push(boundary), writeStartPendingSuspenseBoundary$1(
      destination,
      request.renderState,
      ...
      hoistableState
    )), flushSubtree$1(request, destination, segment, hoistableState), destination.push("<!--/$-->");
  if (boundary.byteSize > request.progressiveChunkSize)
    return boundary.rootSegmentID = request.nextSegmentId++, request.completedBoundaries.push(boundary), writeStartPendingSuspenseBoundary$1(
      destination,
      request.renderState,
      boundary.rootSegmentID
    ), flushSubtree$1(request, destination, segment, hoistableState), destination.push("<!--/$-->");
  ...
  request.renderState.generateStaticMarkup ? destination = true : ((request = boundary.contentPreamble) && writePreambleContribution$1(destination, request), destination = destination.push("<!--/$-->"));
  return destination;
}
  ...
  try {
    if (!(0 < request.pendingRootTasks)) {
      ...
      if (null !== completedRootSegment) {
        ...
        for (renderState = hoistableChunks.length = 0; renderState < completedPreambleSegments.length; renderState++) {
          ...
          for (preamble = 0; preamble < segments.length; preamble++)
            flushSegment$1(request, destination, segments[preamble], null);
        }
      ...
      for (i = 0; i < clientRenderedBoundaries.length; i++) {
        ...
        if (errorDigest) {
          renderState$jscomp$0.push(",");
          var chunk$jscomp$2 = escapeJSStringsForInstructionScripts$1(
            errorDigest || ""
          );
    ...
    0 === request.allPendingTasks && 0 === request.pingedTasks.length && 0 === request.clientRenderedBoundaries.length && 0 === request.completedBoundaries.length && (request.flushScheduled = false, i = request.resumableState, i.hasBody && (partialBoundaries = endChunkForTag$1("body"), destination.push(partialBoundaries)), i.hasHtml && (i = endChunkForTag$1("html"), destination.push(i)), request.status = 14, destination.push(null), request.destination = null);
  }
}
...
function abort$1(request, reason) {
  ...
  try {
    ...
    if (0 < abortableTasks.size) {
      var error = void 0 === reason ? Error(formatProdErrorMessage$1(432)) : "object" === typeof reason && null !== reason && "function" === typeof reason.then ? Error(formatProdErrorMessage$1(530)) : reason;
...
function renderToStringImpl(children, options, generateStaticMarkup, abortReason) {
  ...
  children = createRequest$1(
    ...
    createFormatContext$1(0, null, 0),
    Infinity,
    onError,
    void 0,
    function() {
...
const server_browser = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
